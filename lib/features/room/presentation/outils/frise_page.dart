...
class _FrisePageState extends State<FrisePage> {
  ...
  Widget _buildEvent({
    ...
    return IntrinsicHeight(
      child: Row(
        ...
        children: [
          _buildRail(event: event, isMj: isMj, isLast: isLast),
  ...
  /// Pastille et trait de liaison, à gauche de chaque évènement.
  Widget _buildRail({
    required Map<String, dynamic> event,
    required bool isMj,
    required bool isLast,
    ...
    // à distinguer. Côté MJ, elle rappelle d'un coup d'œil ce qui reste caché.
